...
// **FIX**: Improved toast function to preserve icon and use classes
function showToast(message, type = 'info') {
    const toast = document.getElementById('toast');
    const toastMessage = toast.querySelector('.toast-message');
    
    // Ensure the message element exists before setting text
    if (toastMessage) {
    ...
    // Use classList to manage classes safely
    toast.className = 'toast show'; // Reset classes and add 'show'
    toast.classList.add(type); // Add the type for color styling
